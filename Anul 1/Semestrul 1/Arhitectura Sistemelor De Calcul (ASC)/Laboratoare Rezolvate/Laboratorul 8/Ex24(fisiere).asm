...
segment data use32 class=data
    ; Se dau in segmentul de date un nume de fisier si un text (poate contine orice tip de caracter). Sa se calculeze suma cifrelor din text. Sa se creeze un fisier cu numele dat si sa se scrie texul si in loc sa fie C obtinuta in fisier.
    ;rez = 19
    
     nume_fisier_afisare db "rezultat_24.txt", 0
     nume_fisier_citire db "citire_24.txt", 0
     mod_citire db "r", 0
     mod_scriere db "w", 0
